...
public class RedisConfig {
	...
	public RedisConnectionFactory redisConnectionFactory() {
		RedisStandaloneConfiguration redisConfig = new RedisStandaloneConfiguration("improved-polecat-5123.upstash.io",
				6379);
		redisConfig.setUsername("default");
		redisConfig.setPassword("ARQDAAImcDE4OTEwZmExYzg4OWU0NDdjYTQ0NmNmZTJiZjEwOTQ0NXAxNTEyMw");
